<div class="min-h-screen bg-slate-50 font-sans">
    ...
    @section('title', 'Image Forge | Resizer')
    @section('description', 'Resize images online for free with Image Forge. Scale images to any dimension instantly. Coming soon.')
    @section('og:title', 'Image Forge | Free Online Image Resizer')
    @section('og:description', 'Resize images online for free. Scale images to any dimension instantly. Coming soon.')
        ...
        <div class="relative mx-auto max-w-7xl px-4 pb-20 pt-20 sm:px-6 sm:pb-28 sm:pt-28 lg:px-8">
            <div class="mx-auto max-w-3xl text-center">
                ...
                <p class="mt-4 text-lg leading-relaxed text-slate-300">
                    Scale images to any dimension. Coming soon.
                </p>
            </div>
                ...
                <div class="overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5">
                    <div class="flex flex-col items-center gap-6 p-12 sm:p-16">
                        ...
                        <div class="text-center">
                            <h2 class="text-2xl font-bold text-slate-900">Coming Soon</h2>
                            <p class="mt-2 text-sm leading-relaxed text-slate-500">
                                The image resizer is currently under development. 
                                We're building intuitive scaling tools to help you 
